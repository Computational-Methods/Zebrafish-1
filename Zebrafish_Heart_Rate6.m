function [heartbeats, heart_rate_bps, heart_rate_bpm]= Zebrafish_Heart_Rate5(video)
% Input the movie to the function by typing the movie as a character array
% e.g. Zebrafish_Heart_Rate('movie.mov')

videoReader = VideoReader('Zebrafish.mov');
...
% ROI specification
disp ('On the video use your mouse to select a rectangular shaped ROI covering a small portion of the heart that visibly contracts: ')
...
[peak,locs]= findpeaks(brightness_smooth,time_vector, 'MinPeakDistance', 25)
