function [heartbeats, heart_rate_bps, heart_rate_bpm]= Zebrafish_Heart_Rate3(video)
...
[peak2,locs]= findpeaks(diff_mean_bright,time_vector,'MinPeakProminence',.08, 'MinPeakDistance', 10, 'MinPeakWidth', 3);
